...
![OIP-gjkhfsli.webp](assets/png/articles/16ce27df1101.webp)
...
public class EmployeeTest{
   ...
   public static void main(String[] args){
      /* 使用构造器创建两个对象 */
      Employee empOne = new Employee("xh1");
      Employee empTwo = new Employee("xh2");
...
![32dbacb58042faca7304e50b78f6ecec-txwdpiyz.webp](assets/png/articles/6db0be498afe.webp)
...
![2483a67af9c01ad57860759859aa9424-nchlmquk.webp](assets/png/articles/8da3ce2f0fd4.webp)
...
public class Employee{
   ...
   public static void main(String[] args){
      Employee empOne = new Employee("itxiaohui");
...
![19378e87ca744cc2bf620335fc236b22-viecerft.webp](assets/png/articles/b3d00792e951.webp)
...
![2712874114844dc7b06ef9d6cc261312-webirdej.webp](assets/png/articles/a0f83666139e.webp)
...
![v2-04db124b0016d52a25bdb1ce9c508756_b-hkwzumej.webp](assets/png/articles/2e03f6cc093c.webp)
...
![0cd143cf71da463cbc63e9674ee746d9-qdcpxfif.webp](assets/png/articles/075a033033f4.webp)

### 10-3 Math 的 floor,round 和 ceil 方法实例比较

![1445661-20211223105154559-969130792-bcnfpefd.webp](assets/png/articles/dda3ed935cdc.webp)
...
![1762594902_690f105680b87f13ec17c-leylwewk.webp](assets/png/articles/bf68892134c3.webp)
...
![eb8bee164a9be7f22bea6a5f004d7042-uidzzdfr.webp](assets/png/articles/a4168fbd7ae6.webp)
...
```
String greeting = "小慧博客";

```

在代码中遇到字符串常量时，这里的值是 "小慧博客"，编译器会使用该值创建一个 String 对象。
...
public class StringDemo{
   public static void main(String args[]){
      char[] helloArray = { 'i','t','x', 'i', 'a', 'o', 'h', 'u','i'};
...
public class StringDemo {
    public static void main(String args[]) {
        String site = "www.itxiaohui.top";
        int len = site.length();
        System.out.println( "小慧博客网址长度 : " + len );
   }
}
...
public class StringDemo {
    public static void main(String args[]) {   
        String string1 = "小慧博客网址：";   
        System.out.println("1、" + string1 + "www.itxiaohui.top");  
    }
}
...
下面是 String 类支持的方法，更多详细，参看 [PostgreSQL AUTO INCREMENT](https://www.runoob.com/postgresql/postgresql-autoincrement.html)
...
public class Test{
  public static void main(String args[]){
    StringBuffer sBuffer = new StringBuffer("小慧博客官网：");
    sBuffer.append("www");
    sBuffer.append(".itxiaohui");
    sBuffer.append(".top");
...
> 
> JDK 5 后的版本我们也可以使用 Java Scanner类来获取控制台的输入。
...
- [ByteArrayOutputStream](https://www.runoob.com/java/sqlite-python.html)

- [DataOutputStream](https://www.runoob.com/java/execute_sql_online.php)
...
- [File Class(类)](https://www.runoob.com/java/book.sqlite3.php)

- [FileReader Class(类)](https://www.runoob.com/java/sqlite-jdbc)

- [FileWriter Class(类)](https://www.runoob.com/java/sqlite3.html)
...
**注意：** Java 在 LUNIX 和 Windows 自动按约定分辨文件路径分隔符。如果你在 Windows 版本的 Java 中使用分隔符 (/) ，路径依然能够被正确解析。
...
可以看到 top 字符串并未输出，接下来我们看 nextLine。
...
**我们在收到通知并核实后，将七天内采取包括但不限于删除相关内容等措施。**
